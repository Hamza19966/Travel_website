...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title>Eco-Products Page 2</title>
    <meta charset="utf-8">
...
<div class="container">
        ...
        <header><!-- Defining the header section of the page -->
            ...
            <section id="submenu"><!-- Defining the sub menu -->
                <ul>
                    <li><a href="Eco-Tourisim Shopping.php ">Page 1</a></li>
        ...
        <div id="slider2"><!-- Defining the main content section -->
                ...
                <div id="htmlcaption-1" class="nivo-html-caption">
                    <h5 class="p2">There is promo area.</h5>
                    <p>There are some special offers and sales that will also be listed here.</p>
                </div>
            ...
            <section id="content"><!-- Defining the content section #2 -->
                <div id="left">
                  <h3>Last products</h3>
                    <ul>
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Durian.jpg"></a></div>
                            <div class="info">
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Wau.jpg"></a></div>
                            <div class="info">
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Kongkak.jpg"></a></div>
                            <div class="info">
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Hand wooven.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 4</a>
                                <p>Hand wooven crafts</p>
                                <div class="price">
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Batik.jpg"></a></div>
                            <div class="info">
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Labu.jpg"></a></div>
                            <div class="info">

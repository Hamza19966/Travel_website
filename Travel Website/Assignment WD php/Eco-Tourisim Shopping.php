...
body {
    background: url("file:///C|/Users/FAHAD TAHIR/Documents/images/body-bg.jpg") no-repeat fixed center top #FFFFFF;
    color: #7F7F7F;
...
/* header section */
header {
    background: url("file:///C|/Users/FAHAD TAHIR/Documents/images/header-bg.png") repeat scroll left top #fff;
...
#submenu li a {
    background: url("file:///C|/Users/FAHAD TAHIR/Documents/images/smenup.png") no-repeat scroll 0 9px transparent;
...
#submenu li a:hover {
    background-image: url("file:///C|/Users/FAHAD TAHIR/Documents/images/smenua.png");
}
...
<div class="container">
           ...
           <section id="search"><!-- Search form -->
            ...
            <section id="submenu"><!-- Defining the sub menu -->
                <ul>
                    ...
                    <li><a href="Eco-Tourisim Shopping Page 2.php ">Page 2</a></li>
  ...
  <div id="slider2"><!-- Defining the main content section -->
                ...
                <div id="htmlcaption-1" class="nivo-html-caption">
                    ...
                    <p>From here you can select any of your choice products and inform us so that we can buy for you whatever you choose and pay us later.</p>
                </div>
                <div id="htmlcaption-1" class="nivo-html-caption">
                    <h5 class="p2">This is promo area</h5>
                    <p>Therre are some special offers and sales that will also be listed here.</p>
                </div>
                <div id="htmlcaption-2" class="nivo-html-caption">
                    <h5 class="p2">The delivery of products.</h5>
                    <p>Our staff will deliver all of your choosen products to your dooestep and from there you can also pay us.</p>
                </div>
        ...
        <div id="main"><!-- Defining submain content section -->
            <section id="content"><!-- Defining the content section #2 -->
                <div id="left">
                    ...
                    <ul>
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Pewter.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 1</a>
                                <p>Pewter</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM45.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Rheumatism.png"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 2</a>
                                <p>Rheumatism</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM15.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                                    <a href="#">Add to cart</a>
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Tongkat.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 3</a>
                                <p>Tongkat</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM25.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                                    <a href="#">Add to cart</a>
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Gamat.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 4</a>
                                <p>Gamat</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM29.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                                    <a href="#">Add to cart</a>
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Bah Kut teh.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 5</a>
                                <p>Bah Kut teh</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM10.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                                    <a href="#">Add to cart</a>
                        ...
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Bird Nest.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 6</a>
                                <p> Bird Nest</p>
                                <div class="price">
                                    <span class="st">Our price:</span><strong>RM16.00</strong>
                                </div>
                                <div class="actions">
                                    <a href="#">Details</a>
                                    <a href="#">Add to cart</a>
                ...
                <div id="right">
                    ...
                    <ul>
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Cooking Ware.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 7</a>
                                <div class="price">
                                    <span class="usual">RM250.00 </span>&nbsp;
                                    <span class="special">RM105.00</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Shoes.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 8</a>
                                <div class="price">
                                    <span class="usual">RM250.00 </span>&nbsp;
                                    <span class="special">RM149.99</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="img"><a href="#"><img alt="" src="Suitcases.jpg"></a></div>
                            <div class="info">
                                <a class="title" href="#">Product 9</a>
                                <div class="price">
                                    <span class="usual">RM450 </span>&nbsp;
                                    <span class="special">RM150.25</span>
                                </div>
                            </div>
                        </li>
                        <li>

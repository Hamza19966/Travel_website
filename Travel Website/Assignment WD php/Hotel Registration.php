...
<body>
<form id="booking-form" class="booking-form" name="form1" method="post" action=" Hotel Return.php">
           <div class="main">
          <div class="logo">
           <img src="Logo clear.png">
            ...
            <div id="form-content">
                ...
                <div class="group">
                    ...
                    <div class="addon-right">
                        <input id="date-check-out" name="date-check-out" class="form-control" type="text">
                        <i class="fa fa-calendar"></i>
                    </div>
                </div>
                <div class="group">
                ...
                <div class="group">
                    <label for="room-type">Choose a Hotel</label>
                    <div>
                        <select id="room-type" name="room-type" class="form-control">
                            <option value="1. Berjaya Langkawi Resort">1. Berjaya Langkawi Resort</option>
                            <option value="2. Pelangi Beach Resort & Spa, Langkawi">2. Pelangi Beach Resort & Spa, Langkawi</option>
                            <option value="3. Hotel Adya">3. Hotel Adya</option>
                             <option value="4. Chill Box Langkawi">4. Chill Box Langkawi</option>
                        </select>
                    </div>
                </div>
                <div class="group">

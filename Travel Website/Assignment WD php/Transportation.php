...
<form id="booking-form" class="booking-form" name="form1" method="post" action="">
            <div align="center"><img src="Logo Clear.png" alt="Example Logo" width="288" height="318" class="logo" title="Example Logo"></div>
            <div class="h1">Transportation Reservation </div>
            ...
            <div id="form-content">
                ...
                <div class="group">
                    <label for="room-type">Vehicle type</label>
                    <div>
                        <select id="vehicle-type" name="vehicle-type" class="form-control">
                            <option value="Sedan(5 Seater)">Sedan(5 Seater)</option>
                            <option value="SUV (8 Seater)">SUV (8 Seater</option>
                            <option value="Motorbike (2 Seater)">Motorbike (2 Seater)</option>
                        </select>
                    </div>
                </div>
                
                <div class="group">
                    <label for="room-requirements">Vehicle requirements</label>
                    <div>
                        <select id="vehicle-requirements" name="vehicle-requirements" class="form-control">
                            <option value="No Preference">No Preference</option>
                            <option value="Sunroof (No Roof on Car)">Sunroof (No Roof on Car)</option>
                        </select>
                        </div>
                      </div>
                ...
                <div class="group submit">
                  <label class="empty"></label>
                    <div><input name="submit" type="submit" value="Submit" formaction="Transportation Return.php"/></div>
